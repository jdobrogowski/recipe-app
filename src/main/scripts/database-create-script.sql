...
create table recipe (id bigint not null, cook_time integer, description varchar(255), difficulty varchar(255), text longtext, prep_time integer, preparing longtext, servings integer, url varchar(255), recipe_id bigint, user_id bigint, primary key (id)) engine=InnoDB;
